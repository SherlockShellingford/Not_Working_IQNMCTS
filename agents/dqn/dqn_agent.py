...
NATURE_DQN_OBSERVATION_SHAPE = (1, 9)
...
class DQNAgent(object):
  ...
  def _store_transition(self, last_observation, action, reward, is_terminal, pi):
    ...
    """
    self._replay.add(last_observation, action, reward, is_terminal, pi)
